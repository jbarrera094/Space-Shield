    ...
    function onSubmit() {
        if(!loaded) {
            if(anyPack){
                ...
                alertService.error("No packages available, you must first purchase one or contact us to request your Beta test.");
            }
        }
    }
            ...
            <div className="container pt-3">
                ...
                <div>
                    <section className='d-flex justify-content-center'>
                        <button onClick={onSubmit}  className={`${anyPack ? 'btn btn-primary btn-lg': 'btn btn-secondary btn-lg' } `}>
                            {loaded && <span className="spinner-border spinner-border-sm me-1"></span>}
                            Manage Licenses
                        </button>
                    </section>
                    <hr className=''/>
