...
function Register() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    checkTermCondition: Yup.boolean().oneOf(
      [true],
      "It's necessary to accept terms and conditions"
    ),
  });
    ...
    <Layout>
      <div className="card bg-blur p-4">
        <div className="card-body">
          <h1 className="text-center fs-2 mb-4 text-white">Register Here</h1>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-check mb-3">
              ...
              <label
                ...
                htmlFor="checkTermCondition"
              >
                I accept{" "}
                <Link href={"/termConditions"} className="text-decoration-none">
                  terms and conditions
                </Link>
              </label>
              <div className="invalid-feedback">
                {errors.checkTermCondition?.message}
              </div>
            </div>
            <button
