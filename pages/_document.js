                ...
                <footer className="bg-dark text-white">
                    <div className='d-flex flex-column justify-content-center size-footer'>
                        <div className="px-2 px-md-5 row w-100">
                            ...
                            <div className='my-auto col-12 col-md-4 d-flex justify-content-center justify-content-md-end'>
                                <Link href='#' target='_blank' rel="noopener noreferrer" className='d-flex flex-column justify-content-center text-decoration-none w-fit-contain'>
                                    <FontAwesomeIcon icon={faYoutube} className='footer-icon-social-size my-auto mx-auto'/>
                        ...
                        <div className="px-2 px-md-5 row w-100 text-center">
                            <span> © Copyright {new Date().getFullYear()} Space Shield.</span>
                        </div>
                    </div>
                </footer> 
            </body>
