    ...
    <div className="d-flex flex-column flex-md-row justify-content-between">
      <div className="card text-start shadow custom-w-card">
        <div className="card-body pb-3 px-4">
          <div className="d-flex row">
            <h5 className="card-title text-secondary fs-4 mb-4 col-10">
          ...
          <div className="mt-4 mb-4 d-flex flex-column">
            <p className="fs-6 text-secondary fw-normal mb-2">
              Recommended for small businesses and freelancers, contains the
              following features:
            </p>
            <div className="d-flex mb-2">
              <FontAwesomeIcon
                icon={faCircleCheck}
                className="me-2 my-auto text-primary icon-pack-list-size"
              />
            ...
            <div className="d-flex mb-2 opacity-50">
              <FontAwesomeIcon
                icon={faCircleCheck}
                className="me-2 my-auto text-secondary icon-pack-list-size"
              />
              <span className="fs-6 fw-normal text-decoration-line-through">
          ...
          <Link
            href={`${!userService.userValue ? defaultURL : "/packs/add/1"}`}
            className="btn btn-outline-primary py-2 fw-semibold w-100"
          >
            Monthly Subscription
          </Link>
          <div className="d-flex justify-content-center mt-2 fw-bold">
            <Link
              href="https://wa.me/573202864969?text=Hi! I would like to schedule a demo of LPS CAD."
              target="_blank"
      ...
      <div className="card text-start shadow custom-w-card">
        ...
        <div className="card-body pb-3 px-4">
          <div className="d-flex row">
            <h5 className="card-title text-secondary fs-4 mb-4 col-10">
              Corporative Package Subscription
            </h5>
          </div>
          ...
          <span className="fs-6 fw-normal">
            An annual recurring payment of{" "}
            <b>&euro;2.028 saving 15% (169 EUR/month)</b>.
          </span>
          ...
          <div className="d-flex justify-content-around row">
            <Link
              href={`${!userService.userValue ? defaultURL : "/packs/add/2"}`}
              className="btn btn-success py-2 fw-semibold col-12 col-md-5 mb-2 mb-md-0"
            >
              Annual Subscription
            </Link>
            <Link
              href={`${!userService.userValue ? defaultURL : "/packs/add/21"}`}
              className="btn btn-primary py-2 fw-semibold col-12 col-md-5"
            >
              Monthly Subscription
            </Link>
          </div>
      ...
      <div className="card text-start shadow custom-w-card">
        ...
        <div className="card-body pb-3 px-4">
          <div className="d-flex row">
            <h5 className="card-title text-secondary fs-4 mb-4 col-10">
              Enterprise Package Subscription
            </h5>
          </div>
          <span className="card-text text-secondary text-decoration-line-through">
            <span className="fw-bold fs-6">&euro;</span>
          ...
          <span className="fs-6 fw-normal">
            An annual recurring payment of{" "}
            <b>&euro;3.348 saving 15% (279 EUR/month)</b>.
          </span>
          ...
          <div className="d-flex justify-content-around row">
            <Link
              href={`${!userService.userValue ? defaultURL : "/packs/add/3"}`}
              className="btn btn-outline-primary py-2 fw-semibold col-12 col-md-5 mb-2 mb-md-0"
            >
              Annual Subscription
            </Link>
            <Link
              href={`${!userService.userValue ? defaultURL : "/packs/add/31"}`}
              className="btn btn-outline-primary py-2 fw-semibold col-12 col-md-5"
            >
              Monthly Subscription
            </Link>
          </div>
