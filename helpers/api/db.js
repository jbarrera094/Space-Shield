...
function licenseModel(sequelize) {
    ...
    const attributes = {
        ...
        s23hjg8t: { type: DataTypes.DATE, allowNull: true, defaultValue: new Date(new Date().getTime() - (24 * 60 * 60 * 1000)) },
        nh2398y1t: { type: DataTypes.DATE, allowNull: true, defaultValue: sequelize.literal('CURRENT_TIMESTAMP') },
        lbb73g3n: { type: DataTypes.DATE, allowNull: true, defaultValue: new Date(new Date().getTime() - (24 * 60 * 60 * 1000)) },
        p3dsfuh7l: { type: DataTypes.DATE, allowNull: true, defaultValue: new Date(new Date().getTime() - (24 * 60 * 60 * 1000)) },
